...
* Salary distribution varies significantly across departments, indicating structural pay differences
* Certain job titles consistently fall into higher salary brackets
* Workforce distribution is uneven, with some departments having significantly higher employee counts
* Salary allocation reflects hierarchy and specialization within roles
* Identified clusters of high compensation roles concentrated in specific departments
...
* Understand salary distribution across an organization
* Identify high-cost departments and roles
* Support workforce planning and budgeting decisions
* Provide clarity on organizational pay structure

---

## 📌 Key Highlight

This project intentionally avoids Python and Power BI to demonstrate strong **core data analysis capabilities using SQL and Excel**, which are critical in real-world business environments.
